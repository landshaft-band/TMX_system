...
STATUS_COLORS = {
    ...
    "Ожидает выгрузки": ("#eef1f4", "#5b6773"),
    "Выгружено": ("#e6f0e8", "#2f6b3f"),
    "Ошибка": ("#f5e3e3", "#8a2d2d"),
    "Повторная попытка": ("#f3ecd2", "#7a5a18"),
    "Подключено": ("#e6f0e8", "#2f6b3f"),
    "Подключены": ("#e6f0e8", "#2f6b3f"),
    "Активен": ("#e6f0e8", "#2f6b3f"),
    "Готово": ("#e6f0e8", "#2f6b3f"),
    "Не подключены": ("#f3ecd2", "#7a5a18"),
    "Неактивен": ("#f3ecd2", "#7a5a18"),
